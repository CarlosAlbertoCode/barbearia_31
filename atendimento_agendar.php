                ...
                <ol>
                    ...
                    <li>Selecione o seu serviço <br />
                        <select name="selectServico" class="input">
                            <?php 
                            //PASSO 01: Incluir as definições da BDA
                            include "conexao_bd.php";
                          
                            //PASSO 02: Montar o comando SQL para listar os serviço
                            $sql = "SELECT * FROM servico ORDER BY descricao";

                            //PASSO 03: Executar o SQL e guardar o resultado em uma variável
